  ...
  return (
    <section className="">
      ...
      <Motion.MotionDiv
        ...
        variants={div}
        viewport={{ once: false }}
        className="mb-12 mx-auto flex flex-wrap justify-center items-center grid md:grid-cols-3 md:divide-x grid-cols-1 "
      >
        <Motion.MotionDiv className="logo text-white col-span-1 flex-wrap flex-col items-center m-auto h-full px-12 md:my-0 my-8">
          ...
          >
            ...
            <div className="text-center hover:cursor-pointer">
              <p className="md:text-2xl 2xl:text-4xl text-xl">
                Logos and Artwork
              </p>
            </div>
          </Motion.MotionDiv>
      ...
      <AnimatePresence>
        <div className="absolute">
          <Motion.MotionDiv
            className="md:block hidden flex flex-wrap justify-center items-center logodesc bg-purple-900/50 rounded-lg w-full h-full text-white px-8 text-2xl font-medium leading-light py-4"
            key="logo"
